...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070064, 0x0FFF83FFU ,0x0020804BU)
    */
	PSU_Mask_Write(DDRC_RFSHTMG_OFFSET, 0x0FFF83FFU, 0x0020804BU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(DDRC_DRAMTMG0_OFFSET, 0x7F3F7F3FU, 0x0E0B080CU);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070104, 0x001F1F7FU ,0x00030411U)
    */
	PSU_Mask_Write(DDRC_DRAMTMG1_OFFSET, 0x001F1F7FU, 0x00030411U);
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(DDRC_DRAMTMG2_OFFSET, 0x3F3F3F3FU, 0x0407160DU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD0701B4, 0x00003F3FU ,0x00000904U)
    */
	PSU_Mask_Write(DDRC_DFITMG2_OFFSET, 0x00003F3FU, 0x00000904U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(DDR_PHY_MR14_OFFSET, 0xFFFFFFFFU, 0x0000006FU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(DDR_PHY_VTCR0_OFFSET, 0xFFFFFFFFU, 0xF10329EFU);
/*##################################################################### */
...
unsigned long psu_ddr_phybringup_data(void)
{
	...
	regval = Xil_In32(0xFD070018); /*MRSTAT*/
	regval = Xil_In32(0xFD070018); /*MRSTAT*/
	Xil_Out32(0xFD070014U, 0x00000E6FU);
	Xil_Out32(0xFD070010U, 0x80000018U);
	regval = Xil_In32(0xFD070018); /*MRSTAT*/
	while ((regval & 0x1) != 0x0) {
	/***MRSTAT***/
