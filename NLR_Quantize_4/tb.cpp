...
//	ap_int<32> temp = 40431325;
//	cout << ap_int<32>((temp & 16777216) > 0) << endl;;

#ifndef TEST_CASE
	float multiplier = 0.002746367361396551;
	data_t zpW = 128, zpX = 7, zpXNext = 7;
	data_t n = 8; ap_uint<FIXED_BIT>int_m0 = 3019662848;
	...
	data_t n = 9; ap_uint<FIXED_BIT>int_m0 = 4199226112;
