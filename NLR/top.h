...
void Pooling(uint128 *ifm, uint128 *ofm,
		int inRow, int inCol, int inChannel, int kerSize,
		int Tr, int Tc, int tileNumX, int tileNumY, int tileNumIn,
		uintTi act[MAX_TILE_IN_HEIGHT][MAX_TILE_IN_WIDTH],
		uintAcc psum_output[MAX_TILE_OUT_HEIGHT][MAX_TILE_OUT_WIDTH]);
...
void IFMInit(data_t ifm[inRow][inCol][inChannel], char* mode){
...
template<unsigned inChannel>
void IFMMonitor(data_t act[TEST_INDIM][TEST_INDIM][inChannel], int type){
