...
int main(){
	...
	// quantization
	const float currFMScale = 2.45;
	const data_t currFMZP = 2;

	const float currWGTScale = 1.34;
	const data_t currWGTZP = 4;

	const float nextFMScale = 1.65;
	const data_t nextFMZP = 6;

	const float multiplier = (currFMScale * currWGTScale)/nextFMScale;
...
//	// initialize weight(quantized)
	WGTInit<kerSize, outChannel, inChannel>(weight, currWGTZP, (char*)"channel", dataMode);
