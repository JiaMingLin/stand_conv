...
class FPGA_Conv:
    ...
    def hw_conv(self, hw_input, hw_output, hw_wgt, inRow, inCol, in_channel, out_channel, Tr, Tc, kerSize, stride):
...
if __name__ == "__main__":
    ...
    ofm_depth = int((out_channel*inRow*inCol)/WORD_LENGTH)#300000
    ...
    ofm = initIFM(out_channel,inRow,inCol, mode = "empty")
    ...
    HWConv.hw_conv(ifm_buff, ofm_buff, wgt_buff, inRow, inCol, in_channel, out_channel, Tr, Tc, kerSize, stride)
    ...
    hw_ofm = convertOFMOutput(ofm_buff, ofm_depth, WORD_LENGTH, out_channel, inRow, inCol, Ti)
    # print(ofm_buff)
    err = compareResult(sw_ofm, hw_ofm, out_channel, inRow, inCol)
    print(err)
